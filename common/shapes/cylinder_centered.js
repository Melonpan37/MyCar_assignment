...
function CylinderCentered(resolution) {

    this.name = "cylinder_centered";
    ...
    var radius = 1.0;
    var angle;
    var step = 6.283185307179586476925286766559 / resolution; //2*PI
    ...
    for (var i = 0; i < resolution; i++) {
      ...
      //triangolo
      this.vertices[vertexoffset] = radius * Math.cos(angle); //punto 0
      this.vertices[vertexoffset + 1] = -1.0; //punto centrale (comune a tutti i triangoli del cerchio)
      this.vertices[vertexoffset + 2] = radius * Math.sin(angle); //punto 2
      vertexoffset += 3;
    }
