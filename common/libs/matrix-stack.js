...
MatrixStack.prototype = {
	...
	get inverseTranspose() {
		//EDIT -> REMOVE ALL AND UNCOMMENT 
		var inv = glMatrix.mat4.invert(glMatrix.mat4.create(), this._m).slice();
		var transp = glMatrix.mat4.transpose(inv, inv);
		return transp;
	...
	multiply_lr : function (m){
		glMatrix.mat4.multiply(this._m, m, this._m);
	},
};